...
class dDummyData {
 static final List<FoodModel> foods = [
    ...
    FoodModel(
      ...
      title: "Meaty Rice",
      foodtype: "FOOD",
      image: danImages.LocalJellofRice,
      price: 1500,
      description:
    ...
    FoodModel(
      ...
      image: danImages.PlantainPepperSoup,
      foodtype: "FOOD",
      price: 3100,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Vegetable_salad,
      foodtype: "FOOD",
      price: 900,
      description:
    ...
    FoodModel(
      ...
      image: danImages.steamed_vegetable,
      foodtype: "FOOD",
      price: 500,
      description:
    ...
    FoodModel(
        ...
        image: danImages.Vegetable_Soup,
        foodtype: "FOOD",
        price: 1300,
        description:
    ...
    FoodModel(
      ...
      image: danImages.Charcolite_Chicken,
      foodtype: "PROTEIN",
      price: 2500,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Crunchy_Chicken,
      foodtype: "PROTEIN",
      price: 2500,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Barbecue_Chicken,
      foodtype: "PROTEIN",
      price: 3000,
      description:
    ...
    FoodModel(
      ...
      image: danImages.PhylloSnadwich,
      foodtype: "PASTRY",
      price: 1000,
      description: "",
    ),
    ...
    FoodModel(
      ...
      image: danImages.CelebrationCake,
      foodtype: "CAKES",
      price: 14000,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Blue_Celebration_Cake,
      foodtype: "CAKES",
      price: 10000,
      description:
          "Whether it's a birthday, anniversary, graduation, or any special occasion, our Celebration Cakes are designed to make your moments memorable. Our cakes are a blend of delightful flavors, stunning designs, and exceptional quality, ensuring every bite is a celebration in itself.",
    ...
    FoodModel(
      ...
      image: danImages.Celebration_Cake6,
      foodtype: "CAKES",
      price: 7000,
      description:
          "Whether it's a birthday, anniversary, graduation, or any special occasion, our Celebration Cakes are designed to make your moments memorable. Our cakes are a blend of delightful flavors, stunning designs, and exceptional quality, ensuring every bite is a celebration in itself.",
    ...
    FoodModel(
      ...
      image: danImages.Celebration_Cake8,
      foodtype: "CAKES",
      price: 9000,
      description:
          "Whether it's a birthday, anniversary, graduation, or any special occasion, our Celebration Cakes are designed to make your moments memorable. Our cakes are a blend of delightful flavors, stunning designs, and exceptional quality, ensuring every bite is a celebration in itself.",
    ...
    FoodModel(
      ...
      image: danImages.Celebration_Cake10,
      foodtype: "CAKES",
      price: 8500,
      description:
          "Whether it's a birthday, anniversary, graduation, or any special occasion, our Celebration Cakes are designed to make your moments memorable. Our cakes are a blend of delightful flavors, stunning designs, and exceptional quality, ensuring every bite is a celebration in itself.",
    ...
    FoodModel(
      ...
      image: danImages.OvenFreshBread,
      foodtype: "BREAD",
      price: 1500,
      description:
    ...
    FoodModel(
      ...
      image: danImages.ShortSlicedBread,
      foodtype: "BREAD",
      price: 900,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Chicken_Shawarma,
      foodtype: "SHAWARMA",
      price: 2400,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Special_Shawarma,
      foodtype: "SHAWARMA",
      price: 2700,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Traditional_shawarma,
      foodtype: "SHAWARMA",
      price: 2900,
      description:
    ...
    FoodModel(
      ...
      image: danImages.Hollandia_Youghurt,
      foodtype: "DRINKS",
      price: 1800,
      description:
...
/// hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee ////
  ...
  static final List<BannerModel> banners = [
    ...
    BannerModel(
      id: "002",
      image: danImages.Banner2,
      isFeatured: false,
      name: 'banner2',
    ),
    BannerModel(
      id: "003",
        image: danImages.Banner3,
      isFeatured: false,
        name: 'banner3'
    )
  ];
